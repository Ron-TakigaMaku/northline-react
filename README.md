...
Main editorial introduction

About / Shop

Product-focused section with navigation and product modal
...
Numbered brand values / principles
...
Category-specific editorial introduction

Featured

Numbered editorial cards with modal details

Collection

Category-specific seasonal collection banner

Shop

Product cards, navigation, and product details
...
Component structure / refs when needed

data-id + find()

Passing the selected object directly
